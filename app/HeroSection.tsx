...
export default function HeroSection() {
  return (
    <section className="relative min-h-svh overflow-hidden bg-black text-white">
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-start justify-between px-5 pt-5 sm:px-8 sm:pt-7">
        <Link
          href="/"
        ...
        <div className="pointer-events-auto flex items-center gap-1.5 sm:gap-2">
          <details className="group relative">
            <summary
              className="flex size-10 cursor-pointer list-none items-center justify-center rounded-full border border-white/12 bg-white/6 text-white/78 shadow-2xl shadow-black/40 backdrop-blur-xl transition-all hover:border-cyan-200/40 hover:bg-cyan-200/10 hover:text-cyan-50 [&::-webkit-details-marker]:hidden"
          ...
          <Link
            ...
            className="inline-flex min-h-10 items-center justify-center whitespace-nowrap rounded-full bg-[#45C456] px-3 py-2 text-[10px] font-black uppercase tracking-widest text-black shadow-2xl shadow-black/40 transition-all hover:-translate-y-0.5 hover:bg-[#56d867] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#45C456]/50 sm:px-4 sm:text-xs sm:tracking-[0.14em]"
          >
            <AiOutlineTeam className="size-3.5" aria-hidden="true"/>
            <span className="hidden sm:inline">30min Meeting</span>
          </Link>
          <Link
            href={`mailto:${contact.email}`}
            className="inline-flex h-10 w-10 items-center justify-center gap-2 rounded-full bg-white px-0 text-xs font-black uppercase tracking-[0.16em] text-black shadow-2xl shadow-black/40 transition-all hover:-translate-y-0.5 hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 sm:w-auto sm:px-5"
          >
      ...
      <div
        ...
        <div className="motion-preset-slide-up-sm motion-duration-700 flex flex-col items-center gap-4">
          ...
          <p className="max-w-2xl text-sm font-medium leading-6 text-white/62 sm:text-base">
            Ich entwickle Web-Anwendungen, KI-Agenten und BIM-Lösungen, die Prozesse
            vereinfachen, Planung beschleunigen und Menschen mit Technologie besser
